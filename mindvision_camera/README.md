...
![Build Status](https://github.com/YCYnn/ros2_mindvision_camera/actions/workflows/ros_ci.yml/badge.svg)
...
To build from source, clone the latest version from this repository into your colcon workspace and compile the package using
	...
	mkdir -p ros_ws/src
	cd ros_ws/src
	git clone https://github.com/YCYnn/ros2_mindvision_camera.git
	cd ..
