...
def generate_launch_description():
    ...
    from rm_vision_bringup.common import node_params, launch_params
    from rm_vision_bringup.robot_state_publisher import robot_state_publisher
    from rm_vision_bringup.tracker_node import tracker_node
